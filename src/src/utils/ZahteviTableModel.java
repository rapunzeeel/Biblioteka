...
public class ZahteviTableModel extends AbstractTableModel{
	private static final long serialVersionUID = 3937985517090995701L;
	private ArrayList<ZahtevRezervacijeDTO> lista;
	private String[] columnNames = {"Email", "Ime i prezime","ISBN", "Naslov", "Izdavac" ,"Datum zahteva"};
	
	public ZahteviTableModel(ArrayList<ZahtevRezervacijeDTO> lista) {
		this.lista = lista;
	}
