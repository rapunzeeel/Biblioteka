...
public class RegistracijaBibliotekaraDTO {
	...
	public RegistracijaBibliotekaraDTO(String email, String ime, String prezime, String jmbg,
			Date datumRodjenja, String adresa, String postanskiBroj, TipZaposlenog tipZaposlenog, String nazivFilijale) {
		super();
		this.email = email;
		this.ime = ime;
	...
	public String toString() {
		return "RegistracijaBibliotekaraDTO [email=" + email + ", lozinka=" + ", ime=" + ime + ", prezime="
				+ prezime + ", jmbg=" + jmbg + ", datumRodjenja=" + datumRodjenja + ", adresa=" + adresa
				+ ", postanskiBroj=" + postanskiBroj + ", tipZaposlenog=" + tipZaposlenog + "]";
	}
