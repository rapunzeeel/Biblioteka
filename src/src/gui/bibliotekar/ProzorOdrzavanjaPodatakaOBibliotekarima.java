...
public class ProzorOdrzavanjaPodatakaOBibliotekarima implements Observer {
	...
	private void initialize() {
		...
		pozadina.setTitle("Održavanje podataka o bibliotekarima");
		...
		labelaOdrzavanjeKnjiga.setText("Održavanje podataka o bibliotekarima");
		...
		dugmeBrisanje.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (redTabele != -1) {
					int index = table.convertRowIndexToModel(redTabele);
					String emailBibliotekara = tableModel.getRows().get(index).getEmail();
					new ProzorPotvrdeBrisanja(bibliotekaKontroler, emailBibliotekara, "Da li želite da obrišete bibliotekara?", false);
				}
